CREATE TABLE IF NOT EXISTS private_conversations (
    ...
    participant1_deleted_at DATETIME,
    participant2_deleted_at DATETIME,
...
CREATE INDEX IF NOT EXISTS idx_private_conversations_p1_deleted_at ON private_conversations(participant1_deleted_at);
CREATE INDEX IF NOT EXISTS idx_private_conversations_p2_deleted_at ON private_conversations(participant2_deleted_at);