  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <motion.div
            className="relative w-full max-w-2xl h-auto max-h-[90vh] flex flex-col bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl overflow-hidden"
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    >
                      Organize something for your group
                    </motion.p>
                  </div>
                </div>
                <motion.button
                ...
                >
                  ...
                  <div className="relative">
                    <motion.input
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-xl p-4 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400/50 transition-all duration-300 hover:bg-white/15 text-base"
                      maxLength={100}
                ...
                >
                  ...
                  <div className="relative">
                    <motion.textarea
                      ...
                      className="w-full h-32 bg-white/10 border border-white/20 rounded-xl p-4 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-teal-400/50 focus:border-teal-400/50 resize-none text-base transition-all duration-300 hover:bg-white/15"
                      maxLength={500}
                      initial={{ opacity: 0, scale: 0.95 }}
                      animate={{ opacity: 1, scale: 1 }}
                      transition={{ delay: 0.6, duration: 0.3 }}
                  ...
                  >
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-white/10 border border-white/20 rounded-xl p-4 pl-12 text-white focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400/50 transition-all duration-300 text-base hover:bg-white/15"
                  ...
                  >
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-white/10 border border-white/20 rounded-xl p-4 pl-12 text-white focus:outline-none focus:ring-2 focus:ring-teal-400/50 focus:border-teal-400/50 transition-all duration-300 text-base hover:bg-white/15"
                ...
                >
                  ...
                  <div className="relative">
                    <motion.input
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-xl p-4 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-all duration-300 hover:bg-white/15 text-base"
                      maxLength={200}
                      initial={{ opacity: 0, scale: 0.95 }}
                      animate={{ opacity: 1, scale: 1 }}
            ...
            >
              <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <motion.button
                  ...
                  className={`w-full sm:w-auto px-8 py-3 rounded-xl text-white font-semibold text-sm lg:text-base transition-all duration-300 shadow-lg flex items-center justify-center space-x-2 ${
