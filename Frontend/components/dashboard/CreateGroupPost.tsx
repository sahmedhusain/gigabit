  ...
  return (
    <form onSubmit={handleSubmit} className="create-group-post">
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <label 
          htmlFor="post-image" 
          className="inline-flex items-center space-x-2 px-3 py-2 text-white/70 hover:text-white hover:bg-white/10 border border-white/20 rounded-lg transition-all duration-200 cursor-pointer"
        >
