...
export default function SearchPage({ onClose }: SearchPageProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex justify-center items-start pt-20">
      <div className="bg-white/10 border border-white/20 rounded-2xl shadow-xl w-full max-w-2xl mx-4 h-[70vh] flex flex-col">
        {/* Header */}
        <div className="flex-shrink-0 p-4 border-b border-white/20 flex justify-between items-center">
          ...
          <button onClick={onClose} className="p-2 rounded-full hover:bg-white/10" title="Close search">
