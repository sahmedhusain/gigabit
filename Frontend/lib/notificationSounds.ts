...
export class NotificationSoundGenerator {
  ...
  async playNotificationSound(theme: SoundTheme = 'classic', volume: number = 0.7) {
    ...
    switch (theme) {
      case 'classic':
        // Classic notification: two quick beeps
      ...
      case 'soft':
        // Soft notification: gentle ascending tone
      ...
      case 'modern':
        // Modern notification: quick chirp with reverb effect
...
export async function playNotificationSound(theme: SoundTheme = 'classic', volume: number = 0.7) {
  await notificationSoundGenerator.playNotificationSound(theme, volume)
}

// Test function for different themes
